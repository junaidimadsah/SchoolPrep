...
- [ ] **Day 21: Visual Studio & C# Basics**
  * **Resource:** [Microsoft Learn - C# for Beginners](https://learn.microsoft.com/en-us/shows/csharp-fundamentals-for-beginners/)
...
- [ ] **Day 24: High-Performance Concepts**
  * **Resource:** [Microsoft Learn - Asynchronous Programming](https://learn.microsoft.com/en-us/dotnet/csharp/asynchronous-programming/)
...
- [ ] **Day 31: Bonus - Styling Your Portfolio with Jekyll Themes**
  * **Resource:** [GitHub Docs - Adding a Theme to GitHub Pages](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/adding-a-theme-to-your-github-pages-site-using-jekyll)
  * **Task:** Turn your raw `README.md` portfolio into a fully styled, live webpage using GitHub Pages and a built-in Jekyll theme.
  * **Practice:** In your repository, create a `_config.yml` file and add a theme (like `theme: jekyll-theme-minimal` or `theme: jekyll-theme-hacker`). Commit the changes, enable GitHub Pages in your repository settings, and check out your new live `.github.io` website!
